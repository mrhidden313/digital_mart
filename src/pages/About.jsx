    ...
    return (
        <div className="container" style={{ padding: 'clamp(6rem, 10vw, 10rem) 1rem 3rem', textAlign: 'center' }}>
            <motion.div
                ...
                style={{ maxWidth: '800px', margin: '0 auto', padding: 'clamp(1.5rem, 4vw, 4rem)', borderRadius: '24px' }}
            >
                {/* Logo */}
                <motion.div
                ...
                {whatsappGroup && (
                    ...
                    >
                        ...
                        <a
                            ...
                            style={{ padding: '0.7rem 2rem', fontSize: '0.95rem', borderRadius: '12px' }}
                        >
                ...
                <div style={{ marginTop: '2.5rem', padding: '1.5rem', borderTop: '1px solid var(--glass-border)' }}>
                    <p style={{ fontWeight: '600', fontSize: '0.95rem' }}>Team:</p>
