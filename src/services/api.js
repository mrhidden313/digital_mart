...
const DEFAULT_ITEMS = [
    { id: 1, title: 'Surfshark VPN 1 Year', category: 'Paid', price: 'Rs. 500', type: 'paid', image: '/logo.png', whatsappText: 'I want to buy Surfshark VPN 1 Year', excerpt: 'Premium VPN with unlimited devices and clean IP.', content: '<p>Get official subscription of Surfshark VPN.</p>', tags: ['vpn', 'software'], author: 'Supermart', date: '2025-02-01' },
